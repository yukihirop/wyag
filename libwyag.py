...
whatever it takes to convert it into a meaningful representation. What exactly means depend on each subclass."""
...
def object_read(repo, sha):
  ...
  with open(path, "rb") as f:
    ...
    # Call constructore and return object
...
def kvlm_parse(raw, start=0, dct=None):
  if not dct:
    ...
    # You CANNOT declare the arguments as dct=OrderedDict() or all
...
class GitIndexEntry(object):
  ...
  mtime = None
  """The last time a file7s data changed. This is a tuple (seconds, nanoseconds)"""
